...
public class ExcelRead {
    ...
    String TestDatapath=new java.io.File(".").getCanonicalPath() + "//src//testData//APTestSc.xls";  
    return TestDatapath;
    ...
    public void writeToExistingExcel(String sFileName, String sSheetName, int iCol, int iRow, String sData) throws BiffException, IOException, WriteException{
    	...
    	WritableWorkbook copy = Workbook.createWorkbook(new File(new java.io.File(".").getCanonicalPath() + "//src//testData//APTestSc.xls"), workbook);
